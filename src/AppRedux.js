...
import AppBar from "./containers/AppBarRedux";
    ...
    <div>
      ...
      <Router>
        <Route
          path={"*"}
          render={props => (
            <Sidebar open={sidebarIsOpen} routes={routes} {...props}>
              <Route exact path="/" component={NotesContainer} />
              <Route path="/recordatorios" component={Recordatorios} />
              <Route path="/papel" component={Recordatorios} />
            </Sidebar>
          )}
        />
      </Router>
